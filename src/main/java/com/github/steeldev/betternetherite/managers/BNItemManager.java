    ...
    public static void registerCustomItems() {
        ...
        if (main.config.CUSTOM_MOB_NETHERITE_MARAUDER_ENABLED || main.config.CUSTOM_MOB_NETHERITE_MARAUDER_BRUTE_ENABLED) {
            ...
            if (main.config.CUSTOM_MOB_NETHERITE_MARAUDER_ENABLED) {
                ItemManager.registerNewItem(new MVItem("netherite_marauder_spawn_egg", Material.GHAST_SPAWN_EGG)
                        ...
                        .withCustomModelData(main.config.ITEM_MODEL_DATAS.get("MarauderSpawnEgg"))
        ...
        if (main.config.CUSTOM_MOB_NETHERITE_MARAUDER_BRUTE_ENABLED) {
            ...
            ItemManager.registerNewItem(new MVItem("netherite_marauder_brute_spawn_egg", Material.GHAST_SPAWN_EGG)
                    ...
                    .withCustomModelData(main.config.ITEM_MODEL_DATAS.get("MarauderBruteSpawnEgg"))
        ...
        if (main.config.CUSTOM_MOB_HELLHOUND_ENABLED || main.config.CUSTOM_MOB_ALPHA_HELLHOUND_ENABLED) {
            ...
            if (main.config.CUSTOM_MOB_HELLHOUND_ENABLED) {
                ItemManager.registerNewItem(new MVItem("hellhound_spawn_egg", Material.GHAST_SPAWN_EGG)
                        ...
                        .withCustomModelData(main.config.ITEM_MODEL_DATAS.get("HellhoundSpawnEgg"))
            ...
            if (main.config.CUSTOM_MOB_ALPHA_HELLHOUND_ENABLED) {
                ItemManager.registerNewItem(new MVItem("alpha_hellhound_spawn_egg", Material.GHAST_SPAWN_EGG)
                        ...
                        .withCustomModelData(main.config.ITEM_MODEL_DATAS.get("AlphaHellhoundSpawnEgg"))
        ...
        if (main.config.CUSTOM_MOB_LOST_SOUL_ENABLED) {
            ...
            ItemManager.registerNewItem(new MVItem("lost_soul_spawn_egg", Material.GHAST_SPAWN_EGG)
                    ...
                    .withCustomModelData(main.config.ITEM_MODEL_DATAS.get("LostSoulSpawnEgg"))
        ...
        if (main.config.CUSTOM_MOB_ZOMBIFIED_DEMON_ENABLED) {
            ...
            ItemManager.registerNewItem(new MVItem("zombified_demon_spawn_egg", Material.GHAST_SPAWN_EGG)
                    ...
                    .withCustomModelData(main.config.ITEM_MODEL_DATAS.get("ZombifiedDemonSpawnEgg"))
        ...
        if (main.config.CUSTOM_MOB_TANK_ENABLED) {
            ...
            ItemManager.registerNewItem(new MVItem("demon_tank_spawn_egg", Material.GHAST_SPAWN_EGG)
                    ...
                    .withCustomModelData(main.config.ITEM_MODEL_DATAS.get("DemonTankSpawnEgg"))
